...
export default {
  ...
  knowledgeManage: {
    ...
    author: '作者',
    noData: '暂无数据',
    searchPlaceholder: '按照{category}名称搜索',
    ...
    dbDatabase: {
      ...
      desc: '数据库描述',
      editInfo: '编辑数据库',
      createKnowledge: '新建数据库',
      question: '问题',
      answer: '回答',
      metaData: '元数据',
      uploadTips:
        '支持上传xlsx格式文件，单个文件不超过50MB，单元格长度不超过1200字符，单个文件不超过10页sheet，每页不超过5万行、20列（超出范围的列或行会被自动忽略）',
      exportRecord: '导出记录',
      exportData: '导出全部',
      linkQaDatabase: '关联数据库',
    },
    qaExport: {
      title: '导出记录',
  ...
  generalAgent: {
    ...
    question: {
      ...
      rejected: '已取消',
      replySuccess: '提交成功',
      replyFailed: '提交失败，请重试',
      rejectSuccess: '已取消',
      rejectFailed: '取消失败，请重试',
