...
export default {
  ...
  knowledgeManage: {
    ...
    graph: {
      ...
      finished: 'Completed',
      failed: 'Failed',
      graphStatus: 'Graph Parsing Status',
      useGraph: 'Use Graph',
      graphModel: 'Knowledge Graph Parsing Model',
      successGraphTips:
        'If the schema file content does not match the uploaded document content, the knowledge graph cannot parse the content',
    },
    communityReport: {
      name: '名称',
  ...
  statisticsDashboard: {
    ...
    responseStatus: '响应状态',
    streamCosts: '流式耗时',
    nonStreamCosts: '非流式耗时',
    detailTitle: '调用详情',
    reqStart: '请求开始时间',
    firstTokenCreated: '首Token生成时间',
    lastTokenCreated: '最后Token生成时间',
    apiPromptTokens: '请求Tokens',
    apiCompletionTokens: '生成Tokens',
    apiTotalTokens: '总Tokens',
    reqContent: '请求内容',
    resContent: '响应内容',
    finishReason: '结束原因',
    all: '全部',
  ...
  generalAgent: {
    ...
    message: {
      ...
      none: '无',
      subAgent: '【子智能体】',
      subAgentExecution: 'Sub-Agent Execution',
    },
    workspace: {
      title: '工作空间',
      refresh: '刷新',
      ...
      loading: '加载中...',
      empty: '暂无文件',
      emptyHint: 'AI 生成的文件将显示在这里',
      rootDir: '根目录',
      fileCount: '{count} 个文件',
      downloadSuccess: '下载成功',
      downloadFailed: '下载失败',
      loadFailed: '加载工作空间失败，请稍后重试',
    },
    thinking: {
      title: '思考过程',
      thinking: '思考中...',
