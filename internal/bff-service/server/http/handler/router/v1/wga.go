...
func registerWGA(apiV1 *gin.RouterGroup) {
	...
	mid.Sub("wga").Reg(apiV1, "/general/agent/tool/select", http.MethodGet, v1.GetGeneralAgentToolSelect, "通用智能体工具列表")
	...
	mid.Sub("wga").Reg(apiV1, "/general/agent/conversation/config", http.MethodGet, v1.GetGeneralAgentConfig, "通用智能体配置")
	mid.Sub("wga").Reg(apiV1, "/general/agent/conversation/config", http.MethodPut, v1.UpdateGeneralAgentConfig, "修改通用智能体配置")
